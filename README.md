...
# Configuração da página com imagem de gôndola central como favicon (link externo ilustrativo)
st.set_page_config(
    page_title="Calculadora de Gôndolas", 
    page_icon="https://img.icons8.com/ios-filled/50/shopping-shelves.png", 
    layout="centered"
)

# Cabeçalho com imagem destacada em vez do emoji de carrinho
st.image("https://img.icons8.com/ios-filled/100/shopping-shelves.png", width=80)
